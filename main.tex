...
$\vdash $ option\_1 & Use as written  \\
$\vdash $ $\vdash $ \textit{options\_2} & Options for \textit{option\_1}  \\
...
\begin{tabular}{@{}ll@{}}
\verb!roscore! & Starts a Master, s Parameter Server \\
\textbar       & and a rosout logging node. A Master \\
\textbar       & must be always up. \\
\end{tabular}
